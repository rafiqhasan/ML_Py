#For this exercise, you will use logistic regression and neural networks to recognize handwritten digits (from 0 to 9). Automated handwritten digit
#recognition is widely used today - from recognizing zip codes (postal codes) on mail envelopes to recognizing amounts written on bank checks.
import numpy             as np
...
#X contains the image pixel matrix
#Y contains the classification of image data as 0,1,2,3.....9
